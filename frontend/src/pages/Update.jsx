...
const Update = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`https://dailynews-backend.vercel.app/api/display/${id}`, {
          method: "GET",
        });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://dailynews-backend.vercel.app/api/update/${id}`, {
        method: "PATCH",
        headers: {
